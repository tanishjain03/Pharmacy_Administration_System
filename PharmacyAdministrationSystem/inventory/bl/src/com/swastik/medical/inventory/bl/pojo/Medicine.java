...
{
if(!(object instanceof MedicineInterface))
{
return false;
}            
MedicineInterface otherMedicine;
otherMedicine=(MedicineInterface)object;
return this.name.toUpperCase()==otherMedicine.getName().toUpperCase();
}
public int compareTo(MedicineInterface other)
{
